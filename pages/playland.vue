  ...
  <div id="page-playland">
    ...
    <div class="block-wrapper">
      <div class="block">
        <img
          class="block__img"
          src="@/assets/images/playland/block_1@2x.png"
          alt="block_1"
        />
        <p class="block__text">
          1. 使用電腦/筆電直接點擊【進入 Playland 辦公室】
          <br />
          <span class="light">建議使用 Chrome 瀏覽器，不需安裝其他軟體</span>
        </p>
      </div>
      <div class="block">
        <img
          ...
          alt="block_2"
        />
        <p class="block__text">2. 請選擇角色並輸入ID</p>
      </div>
      <div class="block">
        <img
          class="block__img"
        ...
        />
        <p class="block__text">
          3. 允許麥克風及相機權限，按 Join the Gathering 進入
        </p>
      </div>
      <div class="block">
        <img
        ...
        />
        <p class="block__text">
          4. 若您曾經使用過 Gather Town，可點擊 Skip Tutorial
        </p>
      </div>
      <div class="block">
        <img
      ...
      <div class="block">
        <img
          ...
          alt="block_6"
        />
        <p class="block__text">6. 發現發光物件！請按「x」進行互動</p>
      </div>
      <div class="block">
        <img
          class="block__img"
        ...
        <p class="block__text">
          7. 進入會議空間(private
          space)時，空間外畫面會變暗，這時候空間所有人都能聽到彼此對話，不受距離限制
        </p>
      </div>
      <div class="block">
        <img
